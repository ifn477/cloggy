...
<body>
	<form action="mybaby-save" method="post" enctype="multipart/form-data">
		<div class="babyTable">
			...
			<div>성별을 선택해 주세요
			 <button class="genderbtn">남아</button>
			 <button class="genderbtn">여아</button>
			</div>
			<div>체형을 선택해 주세요
			 <button class="bodytypebtn">날씬</button>
			 <button class="bodytypebtn">보통</button>
			 <button class="bodytypebtn">통통</button>
			</div>
		</div>
