...
<br>
제2조(정의)<br>
① “몰”이란 cloggy가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>
...
① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 cloggy 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.<br>
...
<br>
제25조(적립금/예치금 제도)<br>
1. 적립금과 예치금은 '몰'내에서 현금처럼 사용되는 전자화폐이며, 상품 구매 시에만 사용할 수 있습니다. 단, 적립금의 경우 이용 가능 범위를 몰에서 제한할 수 있습니다.<br>
2. 적립금과 예치금은 본인만 사용 가능하며 타인에게 양도 또는 다른 아이디와 연동할 수 없습니다.<br>
3. 적립금과 예치금은 회원에 한하여 제공되는 서비스이며 현금 환불은 되지 않습니다.<br>
4. 회원에게 적립된 예치금 또는 적립금이 부정한 방법 또는 개인 정보 도용으로 적립된 사실이 인정되는 경우 몰은 해당 포인트를 통보 없이 정정 또는 회수할 수 있습니다.<br>
5. 적립금과 예치금은 타 결제수단(카드 결제,소액 결제,현금)과 함께 사용할 수 있으나 적립금과 예치금의 동시 중복 사용은 불가합니다.<br>
6. 적립금 또는 예치금은 할인 이벤트 등 특정 기간 동안에 지급 및 이용이 제한될 수 있습니다.<br>
7. 회원이 상품 구매나 이벤트 등을 통하여 “몰”로부터 무상 제공받은 적립금의 경우 “몰'에서 정한 기한에 한해 사용 가능합니다.<br>
8. 유효기간 : “몰”로부터 제공받은 적립금의 경우, 유효기간이 경과한 적립금은 자동 소멸됩니다.<br>
9. 적립금 소멸일 기준으로 1년 이상 경과된 적립금은 회수됩니다. 적립금의 유효기간은 지급 시점을 기준으로 12개월이며, 유효기간 내에 사용되지 않은 적립금은 기간 만료 시 자동 소멸됩니다.<br>
10. 이용자가 탈퇴, 자격상실, 1년 이상 무거래(휴면 계정 전환) 등을 원인으로 적립금이 소멸되는 경우 현금으로 반환되지 않고 소멸되며, 소멸된 적립금은 복구가 불가능합니다.<br>
<br>
제26조(플랫폼)<br>
1. '몰'외 타 플랫폼에서 판매하는 상품들은 플랫폼 정책상 '몰'과 판매가 기준이 다를 수 있습니다.<br>
<br>
제27조(구매제한)<br>
① “몰”은 상습적인 반품/취소를 요청하는 구매자에게 구매 제한을 할 수 있습니다.<br>
1. 직전 세달간 구매 주문건에 60% 이상을 반품하는 경우.<br>
2. 반품 환불을 상습적으로 하는 경우<br>
<br>
위와 같은 내용은 일반적인 반품/취소가 아닌, 상습적으로 이루어지는 환불에 해당됩니다.<br>
몰에서는 높은 질의 서비스와 고객님들의 원활한 쇼핑을 제공하기 위해 위 내용에 해당되는 경우, 구매제한 조치가 이루어질 수 있습니다.<br>
<br>
#카카오톡 알림톡 시행에 관한 내용<br>
“cloggy”는 회원가입, 주문안내, 배송안내 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자메시지로 보내드립니다. 카카오톡 알림톡을 통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할 경우, 알림톡 수신 중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기 바랍니다.<br>
<br>
#네이버 알림 시행에 관한 내용<br>
“cloggy”는 회원가입, 주문안내, 배송안내 등 비광고성 정보를 네이버 알림으로 알려드립니다. 네이버 알림을 통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할 경우, 네이버 알림 수신 중 데이터 요금이 발생할 수 있습니다. 네이버 알림 수신을 원치 않으실 경우 반드시 알림을 해제하여 주시기 바랍니다.<br>
<br>
변경이력<br>
이 약관은 2023년 10월 10일부터 시행하며 종전의 약관은 이 약관으로 대체 합니다.<br>
</div>
<br>
