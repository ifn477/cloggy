...
<tr> <td colspan="2" style="text-align: center; border-bottom: none;">
		<input type="submit" value="수정" style="background-color: #e28b3a; width:100px; color: white; margin-top: 30px;">
		<input type="button" value="삭제" style="background-color: #e28b3a; width:100px; color: white;" onclick="location.href='product-delete?product_id=${pmodi.product_id }'"> 
	 </td>
</tr>
</table>
</form>
